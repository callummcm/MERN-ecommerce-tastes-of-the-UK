...
// controllers
import { create, list, read, image, remove, update, listAll, removeFields, fetchRelatedProducts, fetchFeatured, filteredProducts, listProductsPagination, productsCount, productSearch } from '../controllers/product.js'
...
router.get('/related-products/:productId/:categoryId', fetchRelatedProducts)
